...
LDFLAGS="-L$LIB -lbase -lm -Wl,-e,entry_point -lpthread -lGL -lEGL -lwayland-client -lwayland-egl"
...
{
  cd ..
  echo -e "\033[34mTest Executable Path: $(ls $(pwd)/build/tests/graphics_test)\033[0m"
}
